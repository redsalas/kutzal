  ...
  return (
    <footer className="bg-olive-700 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-olive-600">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-olive-200">
            <p>Copyright © 2026 | Kutzal - Pilates Clásico</p>
