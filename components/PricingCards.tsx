  ...
  const pricingPlans = [
    {
      ...
      description: 'Ven a conocer el estudio y experimenta el Pilates Reformer sin ningún compromiso.',
      buttonText: 'Reservar',
      href: '/reservar',
    },
    {
      ...
      description: 'Accede a una clase de Pilates Reformer en el horario que mejor te convenga.',
      buttonText: 'Reservar',
      href: '/reservar',
    },
  ];
